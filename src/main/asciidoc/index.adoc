...
operation::get-events[snippets='request-fields,curl-request,http-request,http-response,response-fields,links']
...
operation::update-event[snippets='request-fields,curl-request,http-request,request-headers,http-response,response-fields,links']